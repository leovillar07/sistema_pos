...
class UsuarioControlador
{
    ...
    {
        $tabla = "usuarios";
        return UsuarioModelo::MdlMostrarUsuarios($tabla, $item, $valor);
    }
            ...
            if (preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingUsuario"]) &&
                ...
                if ($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar) {
                    ...
                    if ($respuesta["estado"] == 1) {
                        ...
                        $ultimoLogin = UsuarioModelo::mdlActualizarUsuario($tabla, $item1, $valor1, $item2, $valor2);
        ...
        if (isset($_POST["nuevoNombre"]) && isset($_POST["nuevoUsuario"]) && isset($_POST["nuevoPassword"])) {
            ...
            if (isset($_FILES["nuevaFoto"]["tmp_name"])) {
                ...
                if ($_FILES["nuevaFoto"]["type"] == "image/jpeg" || $_FILES["nuevaFoto"]["type"] == "image/png") {
                    ...
                    $extension = ($_FILES["nuevaFoto"]["type"] == "image/jpeg") ? ".jpg" : ".png";
                    $ruta = "vistas/img/usuarios/" . $_POST["nuevoUsuario"] . "/" . $aleatorio . $extension;
                    $origen = imagecreatefromjpeg($_FILES["nuevaFoto"]["tmp_name"]);
                    $destino = imagecreatetruecolor($nuevoAncho, $nuevoAlto);
                    imagecopyresized($destino, $origen, 0, 0, 0, 0, $nuevoAncho, $nuevoAlto, $ancho, $alto);
                    ($_FILES["nuevaFoto"]["type"] == "image/jpeg") ? imagejpeg($destino, $ruta) : imagepng($destino, $ruta);
                }
    ...
    public function edicionExitosa()
    {
        echo '<script>
					swal({
						  type: "success",
    ...
    public function edicionErronea()
    {
        echo '<script>
					swal({
						  type: "error",
